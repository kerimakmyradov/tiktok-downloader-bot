...
languages = {
    ...
    "ar": {
        "help": "قم بتنزيل الفيديو أو الصور من tiktok easy \ n أرسل لي رابط فيديو. \ n إذا رأيت أخطاء برسالة لي @kehsando",
    ...
    "he": {
        "help": "הורד סרטון או תמונות מ-tiktok easy\nשלח לי קישור לסרטון.\nאם אתה רואה באגים שלח לי הודעה @kehsando",
